...
import CheckInButton from "@/components/check-in-button" // Assuming CheckInButton component is imported
...
export default async function HomePage() {
  ...
  // Only fetch data if user exists, otherwise show loading/empty state
  if (!user) {
    // User should have been redirected by middleware, but handle gracefully
    return (
      <div className="min-h-svh bg-gradient-to-br from-blue-50 to-purple-50 flex items-center justify-center">
